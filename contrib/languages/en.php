...
$language = array(
	...
	'invoice' => "Invoice",
	'reset_pass_email_title' => "Set up a new password for Media Suite",
	'reset_pass_email_text' => "%s Hi %s, %s %s You recently requested to reset your password for your Media Suite account. Use the button below to reset it. %s",
	'reset_pass_email_after_btn_text' => "%s If you did not request a password reset, please ignore this email. %s %s Thanks, %s The Media Suite Team %s",
	'reset_pass_email_rights' => "%s %s %s   Media Suite. All rights reserved %s",
	...
	'from_date' => "From Date",
	'to_date' => "To Date",
	'facebook_general_title' => "Facebook General Settings",
	'facebook_autoposting' => "Enable Auto posting to Facebook",
	'save' => "Save",
	'facebook_api_setting' => "Facebook API Settings",
	'instagram_api_setting' => "Instagram API Settings",
	'facebook_authentication' => "Facebook Authentication",
	'reddit_authentication' => "Reddit Authentication",
	...
	'add_more' => "Add more",
	'autopost_to_fb' => "Auto post to Facebook",
	'autopost_to_fb_users' => "Auto post Posts to Facebook of this user(s)",
	...
	'gmb_general_settings' => "Google My Business - General Settings",
	'en_autopost_gmb' => "Enable Auto posting to Google My Business",
	'gmb_api_setting' => "Google My Business - API Settings",
	'add_gmb_account' => "Add GMB Account",
	'autopost_to_gmb' => "Auto post to Google My Business",
	'autopost_to_gmb_users' => "Auto post Posts to Google My Business of this user(s)",
	'gmb_btn_type' => "Google My Business - Button Type",
	'gmb_post_img' => "Google My Business Post Image",
	'li_general_setting' => "LinkedIn General Settings",
	'en_autopost_li' => "Enable Auto posting to LinkedIn",
	'li_api_setting' => "LinkedIn API Settings",
	...
	'autopost_to_li' => "Autopost to LinkedIn",
	...
	'ga_tracking_help_text' => "Enable campaign tracking if you want to see how much traffic is generated by Media Suite.",
	...
	'pit_general_settings' => "Pinterest General Settings",
	'pit_authentication'   => "Pinterest Authentication",
	...
	'pit_app_id_key'         => "Pinterest App ID/API Key",
	'pit_app_secret'         => "Pinterest App Secret",
	'pin_app_id_key_plh_text' => "Enter Pinterest App ID / API Key",
	'pin_app_secret_plh_text' => "Enter Pinterest App Secret",
	'pit_session_id' => "Pinterest Session ID",
	'pit_add_account' => "Add Pinterest Account",
	'autopost_to_pit' => "Autopost to Pinterest",
	...
	'twi_general_settings' => "Twitter General Settings",
	'reddit_general_settings' => "Reddit General Settings",
	'en_autopost_twi' => "Enable Autoposting to Twitter",
	'en_autopost_reddit' => "Enable Autoposting to Reddit",
	'twi_api_settings' => "Twitter API Settings",
	...
	'reddit_api_settings' => "Reddit API Settings",
	...
	'autopost_to_twi' => "Autopost To Twitter",
	'autopost_to_reddit' => "Autopost To Reddit",
	...
	'tumb_general_settings' => "Tumblr General Settings",
	'en_autopost_tumb' => "Enable Autoposting to Tumblr",
	...
	'tumb_api_settings' => "Tumblr API Settings",
	...
	'tumb_oauth_consumer_key' => "Tumblr OAuth Consumer Key",
	'tumb_secret_key' => "Tumblr Secret Key",
	'autopost_to_tumb' => "Autopost to Tumblr",
	...
	'delete' => "Delete",
	'create_account_title' => "Your account created at Media Suite",
	'new_account_email_temp_username_text' => "%s Hi %s,%s %s Your account email pending to verification for the Media Suite . Please click the button below to verify your email:%s",
	'verify_now' => "Verify Now",
	'new_account_email_temp_after_btn_text' => "%sIf you can not verify your email using above button, please contact administrator.%s %sThanks,%s The Media Suite Team %s",
	'new_account_email_temp_copy_rights' => "%s %s Media Suite. All rights reserved ",
	'your_subscription_details' => "Your subscription details",
	'view_invoice' => "View Invoice",
	'login_to_account' => "Login to your account",
	'new_account_user_notif_temp' => "%s Hi %s,%s %s Your account created for the Media Suite. please find your login details as below:%s",
	'username' => "Username",
	...
	'print' => "Print",
	'bill_to' => "Bill To",
	'subscription_renew_for' => "Subscription Renew for Media Suite",
	...
	'invalid_email_verification_tokan' => "Invalid email verification token",
	...
	'install_welcome_title' => "Welcome to setup wizard of Media Suite",
	'install_welcome_text' => "This wizard will guide you through the whole installation process",
	'install_step_2_to_6' => "Step 2 of 6 - Server Requirements",
	'install_back' => "Back",
	...
	'install_step_3_to_6' => "step 3 of 6- Database Settings",
	...
	'install_step_4_to_6' => "Step 4 of 6 - Administrator Account",
	...
	'install_step_5_to_6' => "Step 5 of 6 - Ready to Install",
	'install_step_5_help_text' => "All right, sparky! You have made it through this part of the installation. Media Suite can now communicate with your database. If you are ready, time now to...",
	'install' => "Install",
	'install_installation_complate' => "Installation Guide | Complete Installation",
	'install_step_6_to_6' => "Step 6 of 6",
	...
	'install_footer' => "%s Copyright %s %s %s Headfirst %s.%s All rights reserved.",
	'footer' => "%s Copyright %s %s %s Headfirst %s| All Rights Reserved. %s",
	...
	'quick_single_post' => "Quick/single post",
	...
	'instagram_general_title' => 'Instagram General Settings',
	'instagram_autoposting' => "Enable Auto-posting to Instagram",
	'autopost_to_instagram' => "Auto-post To Instagram",
	'autopost_to_insta_users' => "Auto-post Posts to Instagram of this user(s)",
	...
	'blogger_autoposting' => "Enable Auto-posting to Blogger",
	...
	'autopost_to_blogger' => "Auto-post To Blogger",
	'autopost_to_blogger_users' => "Auto-post Posts to Blogger of this user(s)",
