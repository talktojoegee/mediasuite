...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 display: flex;
    margin: 0 auto;" class="email-masthead_name">
                  <img style="width: 150px;" src="<?php echo SAP_SITE_URL .'/assets/images/mingle-logo.png'; ?>" class="mingle-logo" /><p style="margin-bottom: 0;margin-top: 15px;margin-left: 2px;color: #2f5aa9;font-weight: bold;font-size: 20px;"><?php echo SAP_NAME; ?></p></a>
                </div>
              </td>
            </tr>
            <tr>
              <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0">
                  <tr>
                    ...
                    $replace_tags = array($plan_data->name,$cust_plan_result->stripe_subscription_id,$userName,date( "M j, Y g:i a", strtotime($expiration_date) ),SAP_NAME);
