                                ...
                                if (count($all_posts) > 0) {
                                    ...
                                    {  
                                        ...
                                        <tr id="post_<?php echo $post->post_id; ?>">
                                            ...
                                            ?>
                                            <td class="quick-status" <?php echo !empty($shedule) && $post->status == 2 ?  'data-toggle="tooltip" title="'.date('Y-m-d H:i', $shedule).'" ' : '' ?> data-placement="left" ><?php echo $post->status == 1 ? 'Instant' : 'Scheduled'; ?></td>
