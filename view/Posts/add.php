						...
						<div class="box-body">
							...
							<div class="form-group wt-content-image-cs">
								...
								<div class="form-group">
									<input id="post-image" tabindex="3" value="" name="img" type="file" class="file file-loading" data-show-upload="false" data-show-caption="false" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]' data-max-file-size="1024K">
								</div>
							...
							<div class="col-sm-6">
								<div class="form-group">
									...
									<div class="col-sm-4">
										...
										<input type="text" name="sap-schedule-time" readonly="" class="form-control sap-datetime sap-schedule-input">
									</div>
								</div>
							</div>
