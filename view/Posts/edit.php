                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group post-img-edit-pre">
                                ...
                                <?php if (!empty($post_data->img)) { ?>
                                    <input id="post-image" tabindex="3" value="" name="img" type="file" class="file file-loading" data-show-upload="false" data-show-caption="false" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]' data-max-file-size="1024K" data-initial-preview="<img src='<?php echo SAP_IMG_URL . $post_data->img; ?>' class='uploaded-img'/>" >
                                <?php } else { ?>
                                    <input id="post-image" tabindex="3" value="" name="img" type="file" class="file file-loading" data-show-upload="false" data-show-caption="false" data-max-file-size="1024K" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]'/>
                                <?php } ?>
                            ...
                            <div class="col-sm-6 edit-multi-post-schedule">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-4">                
                                        ...
                                        <?php if ( !empty( $post_shedule ) ) { ?>
                                            <input type="text" readonly="readonly" class="form-control" value=" <?php echo!empty( $post_shedule ) ? date('Y-m-d H:i', $post_shedule) : '' ?> " >    
                                        <?php } ?>
                                        <input type="text" name="sap-schedule-time" readonly="" class="sap-datetime form-control sap-schedule-input <?php echo!empty($post_shedule) ? 'obj-inline' : ''; ?>" value=" <?php echo!empty($post_shedule) ? date('Y-m-d H:i', $post_shedule) : '' ?> " >
                                    </div>
                                </div>
                            </div>
