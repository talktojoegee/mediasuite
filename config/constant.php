...
if ( ! defined('SAP_NEW_FB_APP_METHOD_ID') ){
	define('SAP_NEW_FB_APP_METHOD_ID', '423068861904227' ); // FACEBOOK APP ID
}
if ( ! defined('SAP_NEW_FB_APP_METHOD_SECRET') ) {
	define('SAP_NEW_FB_APP_METHOD_SECRET', '37d585819468978caa6ce5fb944c6515' ); // FACEBOOK APP SECRET
}
