...
<script>
    function payWithPaystack(){
        ...
        let total = parseFloat(document.getElementById('unformattedTotal').value);
        let amountCharge = (total * 100)/98.5; //Amount plus charge
        let charge = parseFloat(amountCharge) - parseFloat(total);
