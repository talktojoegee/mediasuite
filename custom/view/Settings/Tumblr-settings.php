...
<?php } ?>
                            <input id="sap_tumblr_img" name="tumblr_image" type="file" class="file file-loading <?php echo!empty($sap_tumblr_options['tumblr_image']) ? 'sap-hide' : ''; ?>" data-show-upload="false" data-max-file-size="1024K" data-show-caption="true" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]' tabindex="15">
