        ...
        <div class="form-group">
            ...
            <div class="col-sm-8">
                <?php if (!empty($sap_pin_custom_img)) { ?>
                    <input id="sap_pin_post_img" name="sap_pinterest_post_img" type="file" class="file file-loading" data-show-upload="false" data-show-caption="true" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]' data-max-file-size="1024K" tabindex="8" data-initial-preview="<img src='<?php echo SAP_IMG_URL . $sap_pin_custom_img; ?>' class='uploaded-img'/>">
                <?php } else { ?>
                    <input id="sap_pin_post_img" name="sap_pinterest_post_img" type="file" class="file file-loading" data-show-upload="false" data-show-caption="true" data-max-file-size="1024K" data-allowed-file-extensions='["png", "jpg","jpeg", "gif"]' tabindex="8">
                <?php } ?>
