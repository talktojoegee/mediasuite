...
$(function () {
	...
	$(document).on('click', '.sap-schedule-icon', function () {
		$(this).hide();
		$(this).parent().parent().removeClass("buttons-display-flex");
		$('.sap-schedule-input').show();
	});
				...
				success: function (response) {
					...
					if (graph_data) {
						...
						google.charts.setOnLoadCallback(function () {
							...
							var chart = new google.visualization.LineChart(document.getElementById('sap-logs-graph'));
