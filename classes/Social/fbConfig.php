...
class SAP_Facebook {
    ...
    public $fbPermissions = array('email', 'public_profile', 'publish_pages', 'pages_manage_posts', 'publish_to_groups');  //Optional permissions
    public $facebook, $settings, $flash, $posts, $common;
