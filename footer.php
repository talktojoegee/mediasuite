...
<?php if ($match['name'] == 'viewpost' || $match['name'] == 'addpost' || $match['name'] == 'quick_posts' || $match['name'] == 'quick_posts_with_id') { ?>
...
if ($match['name'] == 'addpost' || $match['name'] == 'viewpost' || $match['name'] == 'general_settings' || $match['name'] == 'settings' || $match['name'] == 'quick_posts' || $match['name'] == 'quick_posts_with_id') {
...
<!-- search -->
<script src="<?php echo SAP_SITE_URL . '/js/jquery.search.min.js'; ?>" defer onload=''></script>
<!-- custom -->
...
<!-- dataTable End -->
<?php
if ($match['name'] == 'addpost' || $match['name'] == 'settings' || $match['name'] == 'general_settings' || $match['name'] == 'viewpost' || $match['name'] == 'quick_posts' || $match['name'] == 'quick_posts_with_id') {
